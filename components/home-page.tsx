...
const copyEmail = (e: React.MouseEvent) => {
  ...
  navigator.clipboard.writeText("nqovun@gmail.com").then(() => {
    ...
    toast.className =
      "fixed bottom-4 left-1/2 z-50 -translate-x-1/2 transform rounded-full bg-black px-4 py-2 text-sm text-white shadow-lg"
...
export default function HomePage({ latestBlogs }: HomePageProps) {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-white">
      <HeroSection onViewPortfolio={scrollToProjects} onCopyEmail={copyEmail} />
      ...
      <div ref={contentSectionRef} className="relative w-full overflow-hidden bg-white pb-24">
        ...
        <div className="relative z-10">
          <div className="container mx-auto mb-32 px-4">
            ...
            >
              Creating interfaces. Guided by insights. Designed with intention. Made for humans.
              Generated by AI. Creating real value.
            </div>
          </div>
          <Testimonials />
