...
export default function CardspacePage() {
  ...
  const project = {
    "id": 1,
    "name": "CardSpace",
    "tagline": "CardSpace was a platform that helped people store, manage, and use loyalty and rewards cards digitally from their phones instead of carrying physical cards around.",
    "description": "Grew to more than 15 000 customers who could scan and save their loyalty cards, collect rewards, track points in one place.",
