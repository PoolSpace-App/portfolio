    ...
    <PageGridShell>
      <div className="container mx-auto px-4 pt-32 pb-8">
        ...
        <motion.button
          ...
          onClick={() => router.back()}
          className="inline-flex items-center mb-12 hover:opacity-70 transition-opacity text-slate-900 font-medium group"
        >
          <ArrowLeft className="mr-2 h-5 w-5 text-slate-900 group-hover:-translate-x-1 transition-transform" />
          Back to Projects
        </motion.button>
        ...
        <div className="w-full mx-auto">
          ...
          <motion.div {...fadeIn} className="mb-16">
            ...
            <div className="relative py-8">
              ...
              <div className="space-y-1">
                ...
                <div className="text-slate-900 font-medium">{project.role}</div>
              </div>
              <div className="space-y-1">
                <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2">
                  <Clock className="h-3 w-3" /> Duration
                </div>
                <div className="text-slate-900 font-medium">{project.duration}</div>
              </div>
              <div className="space-y-1">
                <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2">
                  <Target className="h-3 w-3" /> Category
                </div>
                <div className="text-slate-900 font-medium">{project.category}</div>
              </div>
              <div className="space-y-1">
                <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest flex items-center gap-2">
          ...
          <div className="mt-24 mb-20 flex flex-col items-center">
            <div className="text-center mb-16">
              <h3 className="text-slate-900 font-bold text-xl mb-3 uppercase tracking-widest">How it works</h3>
              <h2 className="text-5xl md:text-6xl font-bold text-slate-900 tracking-tight">SmartOnboard</h2>
            </div>
          ...
          <div className="relative mt-16 pt-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
              <div className="space-y-12">
                <div className="group">
                  <div className="text-4xl font-bold text-slate-900 mb-2 transition-transform group-hover:translate-x-1">$15.9M</div>
                  <p className="text-lg text-gray-700 leading-snug">in average annual spending on the onboarding process per bank</p>
                </div>
                <div className="group">
                  <div className="text-4xl font-bold text-slate-900 mb-2 transition-transform group-hover:translate-x-1">$14,700</div>
                  <p className="text-lg text-gray-700 leading-snug">average cost per client onboarded.</p>
                </div>
                <div className="group">
                  <div className="text-4xl font-bold text-slate-900 mb-2 transition-transform group-hover:translate-x-1">67%</div>
              ...
              <div className="space-y-12">
                <div className="group">
                  <div className="text-4xl font-bold text-slate-900 mb-2 transition-transform group-hover:translate-x-1">+77 relationships</div>
                  <p className="text-lg text-gray-700 leading-snug">a year for a bank onboarding 1,000 customers annually</p>
                </div>
                <div className="group">
                  <div className="text-4xl font-bold text-slate-900 mb-2 transition-transform group-hover:translate-x-1">$300,000</div>
                ...
                <div className="group">
                  <div className="text-4xl font-bold text-slate-900 mb-2 transition-transform group-hover:translate-x-1">85%</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-slate-50/50 rounded-[40px] p-8 md:p-12 border border-slate-100">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900">Key Takeaways</h3>
                </div>
                
                <div className="space-y-8">
                  <div className="group">
                    <h4 className="font-bold text-blue-900 mb-2 group-hover:text-slate-900 transition-colors">Manual vs. Automated Processing</h4>
                  ...
                  <div className="group">
                    <h4 className="font-bold text-blue-900 mb-2 group-hover:text-slate-900 transition-colors">The 49-Day Benchmark</h4>
                    <p className="text-gray-700 leading-relaxed">
                  ...
                  <div className="group">
                    <h4 className="font-bold text-blue-900 mb-2 group-hover:text-slate-900 transition-colors">Spending Volatility</h4>
                    <p className="text-gray-700 leading-relaxed">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
              ...
              <div className="lg:col-span-7 space-y-12">
                <div className="bg-slate-50 rounded-3xl p-8 md:p-12 relative overflow-hidden group">
                  ...
                  <h3 className="text-xl font-bold text-slate-900 mb-6 relative z-10">The Problem</h3>
                ...
                <div className="bg-blue-50 rounded-3xl p-8 md:p-12 relative overflow-hidden group">
                  <h3 className="text-xl font-bold text-slate-900 mb-6 relative z-10">Why are we doing this?</h3>
                  <ul className="space-y-3 relative z-10 text-gray-700">
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="h-5 w-5 text-slate-900 mt-1 flex-shrink-0" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-slate-100 rounded-[32px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col">
                <div className="bg-blue-50 p-6 flex items-center gap-3">
                  <h3 className="font-bold text-slate-900 text-xl">Customer</h3>
                </div>
                <div className="p-8 space-y-8 flex-grow">
                  ...
                  <div className="pt-4 border-t border-slate-50">
                    <h4 className="text-[10px] font-bold text-slate-900 uppercase tracking-widest mb-4">Needs</h4>
              ...
              <div className="bg-white border border-slate-100 rounded-[32px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col">
                <div className="bg-amber-50 p-6 flex items-center gap-3">
                  <h3 className="font-bold text-slate-900 text-xl">Relationship Manager</h3>
                </div>
                <div className="p-8 space-y-8 flex-grow">
                  <div>
                    <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">Goals</h4>
              ...
              <div className="bg-white border border-slate-100 rounded-[32px] overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col">
                <div className="bg-emerald-50 p-6 flex items-center gap-3">
                  <h3 className="font-bold text-slate-900 text-xl">KYC Analyst</h3>
                </div>
                <div className="p-8 space-y-8 flex-grow">
                  <div>
                    <h4 className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">Goals</h4>
          ...
          <section className="mb-32">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">Design Methodology</h2>
              ...
              items={[
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-slate-50/50 rounded-[40px] p-8 md:p-16 border border-slate-100">
                      <div className="relative aspect-video rounded-4xl overflow-hidden border border-slate-200 bg-white">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="inline-flex items-center rounded-full border border-white bg-white/80 px-6 py-2.5 text-sm font-medium text-slate-900 backdrop-blur shadow-xl">User Flow Analysis</div>
                        </div>
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">Understanding the User Journey</h3>
                        ...
                        <ul className="space-y-4 mb-8">
                          {["Journey mapping current friction points", "Competitive benchmarking with bank managers", "Technical feasibility audit with engineering", "Data requirement consolidation"].map((item, i) => (
                            <li key={i} className="flex items-start gap-3 text-gray-700">
                              <CheckCircle2 className="h-6 w-6 text-slate-900 flex-shrink-0" /> {item}
                            </li>
                          ))}
                        </ul>
                  ...
                  content: (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-slate-50/50 rounded-[40px] p-8 md:p-16 border border-slate-100">
                      <div className="order-2 md:order-1">
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">Wireframing & Solutioning</h3>
                      ...
                      <div className="relative aspect-video rounded-4xl overflow-hidden border border-slate-200 bg-white order-1 md:order-2">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="inline-flex items-center rounded-full border border-white bg-white/80 px-6 py-2.5 text-sm font-medium text-slate-900 backdrop-blur shadow-xl">Rapid Prototyping</div>
                        </div>
                      </div>
                    </div>
                  )
                  ...
                  content: (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-slate-50/50 rounded-[40px] p-8 md:p-16 border border-slate-100">
                       <div className="relative aspect-video rounded-4xl overflow-hidden border border-slate-200 bg-white">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="inline-flex items-center rounded-full border border-white bg-white/80 px-6 py-2.5 text-sm font-medium text-slate-900 backdrop-blur shadow-xl">High Fidelity UI</div>
                        </div>
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">Crafting the Interface</h3>
                ...
                },
                {
                  ...
                  content: (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center bg-slate-50/50 rounded-[40px] p-8 md:p-16 border border-slate-100">
                      <div className="order-2 md:order-1">
                        <h3 className="text-2xl font-bold text-slate-900 mb-4">Validation & Iteration</h3>
                      ...
                      <div className="relative aspect-video rounded-4xl overflow-hidden border border-slate-200 bg-white order-1 md:order-2">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="inline-flex items-center rounded-full border border-white bg-white/80 px-6 py-2.5 text-sm font-medium text-slate-900 backdrop-blur shadow-xl">User Testing</div>
                        </div>
                      </div>
                    </div>
                  )
          ...
          <section className="mb-24 py-24 bg-slate-50 rounded-[64px] text-center border border-slate-100 relative overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto px-4 relative z-10">
              <h2 className="text-4xl font-bold text-slate-900 mb-8">The Result & Impact</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <div>
                  <div className="text-5xl font-bold text-slate-900 mb-2">79%</div>
                  <p className="text-gray-600 font-medium">Reduction in dropout rates</p>
                </div>
                <div>
                  <div className="text-5xl font-bold text-slate-900 mb-2">49 → few days</div>
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <div className="text-left">
                  <div className="font-bold text-slate-900">Cody Poole</div>
